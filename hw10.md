...
* Reads in [the log files](/static_files/hashtables) containing the lists of IP addresses
* Uses one of your Hash Table implementations to check cross references the IP addresses from 1982 with those from 2024 to find the overlap
...
1. Which IP address did you find?
