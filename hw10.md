...
Download the folder [DataFiles](static_files/DataFiles.zip) to use for testing your work. Of course, feel free to use your own folder/files for testing purposes.
