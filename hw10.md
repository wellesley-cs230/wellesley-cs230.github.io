...
# Homework 10: Who did it?

**Context:** Last week, Professors Yacoby and Sandu embarked on an epic, never-ending saga of rivalry with the world's most cunning nemesis: the west-wing scanner. It all began when it gleefully devoured your CS 230 midterms and spewed forth an artistic masterpiece that looked more like a 3D Rorschach tests. Thankfully, Professor Sohie Lee was around to help me turn things around. Watching her work her magic, we learned that the printer only responds well to scented candles, words of affirmation, and lots (and lots) of encouragement. But what caused the printer to behave like this?

Enter Professors Turbak and Metaxas, whose tenure in the department dates back to the early 1900s—or so the legend goes. They reminisced about a chilly winter evening in 1982 when the scanner apparently committed "unspeakable things" that still induce dramatic pauses today. Their theory? The printer was hacked!

In an effort to unravel the mystery, Professors Yacoby and Sandu enlisted the expertise of Professor Anderson, who helped them snag the scanner's logs, chronicling every IP address that dared whisper sweet nothings into its circuits. However, the professors were so traumatized by the scanner's antics that they seemed to have forgotten how to implement all data structures. Now, they desperately need your help.

If the scanner logs from 1982 reveal the same IP address as that fateful night when the midterms became modern art, it means our dear printer wasn't just hacked—it was haunted by the same techno-ghost! Dust off your detective hat, because this is one glitch in the matrix you won't want to miss. Your mission, should you choose to accept it, is to determine if the same IP address was found in both logs.
