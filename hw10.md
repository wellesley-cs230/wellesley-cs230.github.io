...
Professors Turbak and Metaxas, who have been at the department since the early 1900s recall a snowy winter eve in 1982 in which the scanner did "unspeakable things." They believe that the printer was, in fact, hacked. We will have to put their theory to the test. 

With the help of Professor Anderson, Professors Yacoby and Sandu were able to acquire the logs to the scanner, listing all IP addresses that made contact with it. However, they were so traumatized by the scanner, they seemed to have forgetten how to implement all data structures. They need **your help** to analyze the scanner logs. If the scanner logs from 1982 contain the same IP address as the one from the night of the incident, that means the printer was not only hacked, but was hacked by the same hacker! 
